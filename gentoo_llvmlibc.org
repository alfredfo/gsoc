...
dependencies, as well as some runtime issues that caused
crashes. During this project I learned a lot, for example,
...

Before GSoC I was somewhat experienced with C++, the Windows API, x86
assembly, and low level debugging
...
