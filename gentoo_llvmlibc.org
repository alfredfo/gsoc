...
Linux and Fuchsia) C standard library part of the LLVM project.
...
Fuchsia currently uses a mixture of musl and LLVM libc. It does not
...
to temporarily hack in some math functions as alluded to earlier. Later in this
project I will work on getting these upstreamed.
